---
title: IREE中的scheduler和tuning
author: tfruan
date: 2023-06-16 20:00:00 +0800
categories: [IREE]
tags: [IREE, Auto-Schedule]
---
...
## [dispatch_profiler](https://github.com/iree-org/iree/blob/main/experimental/dispatch_profiler/README.md)

IREE 有个调度探查器（dispatch_profiler），该调度探查器会使用 [generator.py](https://github.com/iree-org/iree/blob/main/experimental/dispatch_profiler/generator.py) 生成MLIR Dispatch，然后将这些MLIR Dispatch编译为二进制(vmfb)以验证功能和性能

- 使用 [generator.py](https://github.com/iree-org/iree/blob/main/experimental/dispatch_profiler/generator.py) 生成dispatch
...
- 使用[compile.py](https://github.com/iree-org/iree/blob/main/experimental/dispatch_profiler/compile.py)将生成的dispatch编译为二进制（vmfb）
...
- 使用[profiling.py](https://github.com/iree-org/iree/blob/main/experimental/dispatch_profiler/profiler.py)进行功能验证和性能调优
